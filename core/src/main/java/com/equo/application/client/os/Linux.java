...
/**
 * The {@code Linux} class represents Linux-specific directories and their paths in the file system.
 * It extends the {@code CommonFolders} class and provides methods to retrieve paths for cache,
 * data, state, runtime, and config directories on Linux systems.
 */
